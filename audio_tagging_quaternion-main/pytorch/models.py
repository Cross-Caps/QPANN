...
# Total params: 81,837,071
# Trainable params: 80,753,615
# Non-trainable params: 1,083,456
# Total mult-adds (G): 21.09
# ==========================================================================================
# Input size (MB): 1.28
# Forward/backward pass size (MB): 267.34
# Params size (MB): 327.35
# Estimated Total Size (MB): 595.97
...
# model  = Cnn6(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=527)
# # print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
# model  = ResNet22(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=527)
# print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
# model  = ResNet38(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=527)
# print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
# model  = ResNet54(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=528)
# print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
# model  = Cnn14_emb512(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=528)
# print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
# model  = Cnn14_emb128(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=528)
# print(model(torch.rand(1,10*32000)))
# summary(model, (1,10*32000))
...
model  = Cnn14_emb32(sample_rate=32000, window_size=1024, hop_size=320, mel_bins=64,fmin=50,fmax=14000,classes_num=528)
print(model(torch.rand(1,10*32000)))
summary(model, (1,10*32000))
